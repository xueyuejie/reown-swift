...
public final class UserDefaultsStorage: KeychainStorageProtocol {

    private let service: String
    private let accessGroup: String
    private let synchronizationQueue = DispatchQueue(label: "com.yourapp.UserDefaultsStorage")

    private let secItem: UserDefaultsServiceProtocol

    public init(
        UserDefaultsService: UserDefaultsServiceProtocol = UserDefaultsServiceWrapper(),
        serviceIdentifier: String,
        accessGroup: String
    ) {
        self.secItem = UserDefaultsService
    ...
    public func add(data: Data, forKey key: String) throws {
        ...
        guard status == errSecSuccess else {
            throw UserDefaultsError(status)
        }
    }
    ...
    private func tryToMigrateKeyToNewAccessGroupOnUpdate(data: Data, key: String) throws {
        ...
        guard updateStatus == errSecSuccess else {
            throw UserDefaultsError.itemNotFound
        }
    }
